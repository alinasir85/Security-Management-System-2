...
<script>
    ...
    function()
    {
       ...
       $("#save").click(function(){
	     ...
	     var alphanumExp = /^[0-9a-zA-Z\d\s]+$/;
             ...
             {
                 var dataToSend = {"action":"savePermission","data":obj};
    ...
    function deletePermission(id){
       ...
       // var id=$(this).val();
       // alert(id);
        var dataToSend = {"action":"deletePermission","id":id};
    ...
    function editPermission(id)
    {
           editFlag=1;
           //var id=$(this).val();
           var data={"action":"editPermission","id":id};
           var settings={
               type:"POST",
               dataType:"json",
               data:data,
    ...
    function show(){
			...
			var dataToSend = {"action":"getPermissionGrid"};
        ...
        <br><br><br>
            ...
            <div class="left">
                ...
                <table style=" border-collapse: collapse;">
                    <thead>
                        <tr>
                            <td style="background-color:#555;color:white;padding-left:20px;" width="230px" height="40px"><b>Permission Management</b></td>
                       </tr>
                    </thead>
